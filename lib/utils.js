...
/**
 * Formats text with line breaks preserved for display in HTML
 * @param {string} text - Text with line breaks
 * @returns {Array} - Array of text fragments with line break indicators
 */
export function formatTextWithLineBreaks(text) {
  if (!text) return [];
  
  // Split text by line breaks and create array of fragments
